...
// Addresses are all offsets from DSU_CTRL
#define DSU_TIMETAG		0x000008

#define DSU_BREAK_STEP		0x000020	/* mapped only in CPU0 DSU */
#define DSU_MODE_MASK		0x000024	/* mapped only in CPU0 DSU */

#define DSU_AHB_TRACE_CTRL	0x000040
#define DSU_AHB_TRACE_IDX	0x000044

#define DSU_AHB_BP_ADDR_1	0x000050
#define DSU_AHB_MASK_1		0x000054
#define DSU_AHB_BP_ADDR_2	0x000058
...
#define DSU_IU_REG		0x300000

#define DSU_IU_REG_CHECKBITS	0x300800

#define DSU_FPU_REG		0x301000

#define DSU_IU_SPECIAL_REG	0x400000

#define DSU_REG_Y		0x400000
#define DSU_REG_PSR		0x400004
#define DSU_REG_WIM		0x400008
#define DSU_REG_TBR		0x40000C
#define DSU_REG_PC		0x400010
#define DSU_REG_NPC		0x400014
#define DSU_REG_FSR		0x400018
#define DSU_REG_CPSR	0x40001C
...
//uint32_t DSU_BASE(uint32_t cpu);
